...
function SentimentBarChart(props) {
  return __jacJsx(ResponsiveContainer, {
    ...
    "dataKey": "date"
  }, []), __jacJsx(YAxis, {}, []), __jacJsx(Tooltip, {}, []), __jacJsx(Legend, {}, []), __jacJsx(Bar, {
    "dataKey": "Positive",
    "fill": "#4CAF50"
  }, []), __jacJsx(Bar, {
    "dataKey": "Negative",
...
function SummaryCard(props) {
  ...
  }, ["Click the Generate Summary button to generate summary."]), __jacJsx("div", {
...
function SuggestionsCard(props) {
  var displayText = props.suggestions;
  return __jacJsx("div", {
    "className": "card"
  }, [__jacJsx("h2", {
    "className": "section-title"
  }, ["Suggestions"]), __jacJsx("p", {
    "className": "section-subtitle"
  }, ["Click the Generate Suggestions button to generate suggestions."]), __jacJsx("div", {
    "className": "summary-box"
  }, [props.loading && __jacJsx("div", {
    "className": "flex justify-center items-center my-3"
  }, [__jacJsx("div", {
    ...
    "className": "ml-2 text-sm text-gray-500"
  }, ["Generating suggestions..."])]), displayText])]);
}
